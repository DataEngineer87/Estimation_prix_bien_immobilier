...
# Image
image = Image.open('/home/sacko/Documents/AppliDvf/immo.jpg')
...
def load_model():
    modele_path = "R.forest_DVF.pkl"
    if not os.path.exists(modele_path):
        st.error("❌ Le fichier 'R.forest_DVF.pkl' est introuvable.")
        return None
...
if model is not None:
    ...
    code_postal_encoded, Surface_terrain, Surface_reelle_bati, Nombre_pieces_principales,
    annee_mutation, mois_mutation, Nature_mutation_Adjudication, Nature_mutation_Echange, 
    Nature_mutation_Expropriation, Nature_mutation_Vente, Nature_mutation_Vente_etat_futur_achevement,
    ...
    try:
        ...
        #st.success(f"💶 Estimation du prix au m² : **{prediction:.2f} €**")
        st.info(f"🏷️ Estimation du prix total : **{prediction * Surface_reelle_bati:.2f} €**")
